!(function (e) {
  var o = function () {
          for (var e = arguments[0], i = [].slice.call(arguments, 1), n = 0; n < i.length; ++n) {
              var t = i[n];
              for (key in t) {
                  var r = t[key];
      ...
      i = { wav: "WebAudioRecorderWav.min.js", ogg: "WebAudioRecorderOgg.min.js", mp3: "WebAudioRecorderMp3.min.js" },
      n = {
          workerDir: "/",
          numChannels: 2,
          encoding: "wav",
          options: { timeLimit: 300, encodeAfterRecord: !1, progressInterval: 1e3, bufferSize: 4096, wav: { mimeType: "audio/wav" }, ogg: { mimeType: "audio/ogg", quality: 0.5 }, mp3: { mimeType: "audio/mpeg", bitRate: 160 } },
      },
      t = function (e, i) {
          o(this, n, i || {}),
              (this.context = e.context),
              null == this.context.createScriptProcessor && (this.context.createScriptProcessor = this.context.createJavaScriptNode),
  ...
  o(t.prototype, {
      ...
      setOptions: function (e) {
          this.isRecording() ? this.error("setOptions: cannot set options during recording") : (o(this.options, e), this.worker.postMessage({ command: "options", options: this.options }));
      },
      startRecording: function () {
          if (this.isRecording()) this.error("startRecording: previous recording is running");
              ...
              (this.processor = this.context.createScriptProcessor(this.options.bufferSize, this.numChannels, this.numChannels)),
                  ...
                  (this.processor.onaudioprocess = function (n) {
                      for (var t = 0; t < e; ++t) o[t] = n.inputBuffer.getChannelData(t);
                      i.postMessage({ command: "record", buffer: o });
                  }),
      ...
      recordingTime: function () {
          return this.isRecording() ? 0.001 * (Date.now() - this.startTime) : null;
      },
      ...
      initWorker: function () {
          null != this.worker && this.worker.terminate(), this.onEncoderLoading(this, this.encoding), (this.worker = new Worker(this.workerDir + i[this.encoding]));
          var e = this;
          (this.worker.onmessage = function (o) {
              ...
              this.worker.postMessage({ command: "init", config: { sampleRate: this.additional_config.sampleRate || this.context.sampleRate, numChannels: this.numChannels }, options: { ...this.options, ...this.additional_config } });
      },
      error: function (e) {
